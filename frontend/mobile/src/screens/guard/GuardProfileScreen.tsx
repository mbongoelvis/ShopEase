...
export const GuardProfileScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      <ScrollView style={styles.body} contentContainerStyle={{ paddingBottom: 40 }}>
        <View style={styles.avatarSection}>
          ...
          <Text style={styles.userName}>Peter M.</Text>
          <Text style={styles.userRole}>Security Guard — Buea Town</Text>
        </View>
